...
def detail_url(recipe_id):
    """Create and return URL for recipe details."""
...
class PrivateRecipeApiTest(TestCase):
    ...
    def test_partial_update_recipe(self):
        ...
        payload = {'title': 'Test title changed'}
        url = detail_url(recipe.id)
    ...
    def test_update_user_returns_error(self):
        ...
        new_user = create_user(email='newuser@example.com', password='securepassword1')
        recipe = create_recipe(user=self.user)
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 60,
            'price': Decimal('3.98'),
            'ingredients': [{'name': 'Salt'}, {'name': 'Corn'}]
        }
    ...
    def test_creating_a_recipe_with_existing_ingredient(self):
...
class ImageUploadTests(TestCase):
    """Test for the uploading image API."""
